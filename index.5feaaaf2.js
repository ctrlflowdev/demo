...
var _svelte = require("svelte");
function add_css(target) {
    _internal.append_styles(target, "svelte-etodq9", "@import url('https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@300&family=Roboto:wght@100;300;400;500&display=swap');.nav-bar.svelte-etodq9{width:100%;height:60px;background-color:rgb(36, 36, 36);box-shadow:0 -10px 15px;display:flex;align-items:center;color:white;padding:0 5vw}.nav-banner.svelte-etodq9{display:inline-block;text-align:center;font-size:24px;cursor:pointer}.brand-segment-lowcode.svelte-etodq9{font-weight:300;font-family:'Roboto Mono', monospace}.brand-segment-devkit.svelte-etodq9{font-weight:500;font-family:'Roboto', sans-serif;color:rgb(234, 136, 0);font-size:25px}");
}
function create_fragment(ctx) {
    let nav;
    let div;
    ...
    return {
        c () {
            ...
            div.innerHTML = `<span class="brand-segment-lowcode svelte-etodq9">lowcode</span><span class="brand-segment-devkit svelte-etodq9">DevKit</span>`;
            _internal.attr(div, "class", "nav-banner svelte-etodq9");
            _internal.attr(nav, "class", "nav-bar svelte-etodq9");
        },
        m (target, anchor) {
