...
function add_css(target) {
    _internal.append_styles(target, "svelte-1fqlbsf", ".background.svelte-1fqlbsf{background-color:rgb(245, 245, 245);position:fixed;left:0;right:0;top:0;bottom:0;font-family:'Roboto', sans-serif;overflow-y:auto}.main-body.svelte-1fqlbsf{height:calc(100vh - 60px)}");
}
function create_fragment(ctx) {
    ...
    workflowlookup = new _workflowLookupSvelteDefault.default({});
    return {
        c () {
            ...
            _internal.create_component(workflowlookup.$$.fragment);
            _internal.attr(div0, "class", "main-body svelte-1fqlbsf");
            _internal.attr(div1, "class", "background svelte-1fqlbsf");
        },
        m (target, anchor) {
            ...
            _internal.mount_component(workflowlookup, div0, null);
            current = true;
        },
        p: _internal.noop,
        i (local) {
            ...
            _internal.transition_in(workflowlookup.$$.fragment, local);
            current = true;
        },
        o (local) {
            _internal.transition_out(nav.$$.fragment, local);
            _internal.transition_out(workflowlookup.$$.fragment, local);
            current = false;
        },
        d (detaching) {
            if (detaching) _internal.detach(div1);
            _internal.destroy_component(nav);
            _internal.destroy_component(workflowlookup);
        }
    };
}
class App extends _internal.SvelteComponent {
    constructor(options){
        super();
        _internal.init(this, options, null, create_fragment, _internal.safe_not_equal, {}, add_css);
    }
}
exports.default = App;

},{"svelte/internal":"iVhnC","./Nav.svelte":"fVA3i","./pages/WorkflowLookup.svelte":"6MRQ8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"iVhnC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function add_css(target) {
    _internal.append_styles(target, "svelte-1c4isrc", "@import url('https://fonts.googleapis.com/css2?family=Roboto+Mono:wght@300&family=Roboto:wght@100;300;400;500&display=swap');.nav-bar.svelte-1c4isrc{width:100%;height:60px;background-color:rgb(36, 36, 36);box-shadow:0 -10px 15px;display:flex;align-items:center;color:white}.nav-banner.svelte-1c4isrc{display:inline-block;margin-left:45px;margin-right:160px;text-align:center;font-size:24px}.brand-segment-lowcode.svelte-1c4isrc{font-weight:300;font-family:'Roboto Mono', monospace}.brand-segment-devkit.svelte-1c4isrc{font-weight:500;font-family:'Roboto', sans-serif;color:rgb(234, 136, 0);font-size:25px}.nav-items.svelte-1c4isrc{display:inline-block;font-family:'Roboto', sans-serif}.nav-item.svelte-1c4isrc{display:inline-block;margin-right:30px;font-size:18px;font-weight:300}.nav-active.svelte-1c4isrc{font-size:22px;margin-right:45px;font-weight:400}");
}
function create_fragment(ctx) {
    let nav;
    return {
        c () {
            ...
            nav.innerHTML = `<div class="nav-banner svelte-1c4isrc"><span class="brand-segment-lowcode svelte-1c4isrc">lowcode</span><span class="brand-segment-devkit svelte-1c4isrc">DevKit</span></div> 
  <div class="nav-items svelte-1c4isrc"><div class="nav-item nav-active svelte-1c4isrc">Editor</div> 
    <div class="nav-item svelte-1c4isrc">Activity</div></div>`;
            _internal.attr(nav, "class", "nav-bar svelte-1c4isrc");
        },
        m (target, anchor) {
...
},{"svelte/internal":"iVhnC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6MRQ8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/* src/components/pages/WorkflowLookup.svelte generated by Svelte v3.48.0 */ var _internal = require("svelte/internal");
var _workflowSvelte = require("./editor/Workflow.svelte");
...
function create_else_block(ctx1) {
    ...
    let mounted;
    let dispose;
    let each_value_3 = /*workflows*/ ctx1[2];
    let each_blocks_3 = [];
    for(let i7 = 0; i7 < each_value_3.length; i7 += 1)each_blocks_3[i7] = create_each_block_3(get_each_context_3(ctx1, each_value_3, i7));
    let each_value_2 = /*metadata*/ ctx1[1]?.eventDefs || [];
    let each_blocks_2 = [];
    for(let i1 = 0; i1 < each_value_2.length; i1 += 1)each_blocks_2[i1] = create_each_block_2(get_each_context_2(ctx1, each_value_2, i1));
    let each_value_1 = /*metadata*/ ctx1[1]?.actionDefs || [];
    let each_blocks_1 = [];
    for(let i2 = 0; i2 < each_value_1.length; i2 += 1)each_blocks_1[i2] = create_each_block_1(get_each_context_1(ctx1, each_value_1, i2));
    let each_value = /*metadata*/ ctx1[1]?.workflowDefs || [];
    let each_blocks = [];
    for(let i3 = 0; i3 < each_value.length; i3 += 1)each_blocks[i3] = create_each_block(get_each_context(ctx1, each_value, i3));
    return {
        c () {
        ...
        p (ctx, dirty) {
            ...
            if (dirty & /*metadata*/ 2) {
                each_value_2 = /*metadata*/ ctx[1]?.eventDefs || [];
                let i;
            ...
            if (dirty & /*metadata*/ 2) {
                each_value_1 = /*metadata*/ ctx[1]?.actionDefs || [];
                let i;
            ...
            if (dirty & /*metadata*/ 2) {
                each_value = /*metadata*/ ctx[1]?.workflowDefs || [];
                let i;
...
// (33:0) {#if selectedWorkflow}
function create_if_block(ctx2) {
    let workflow;
    let current;
    workflow = new _workflowSvelteDefault.default({
        props: {
            workflow: /*selectedWorkflow*/ ctx2[0]
        }
    });
    workflow.$on("close", /*close_handler*/ ctx2[4]);
    return {
        c () {
            _internal.create_component(workflow.$$.fragment);
        },
        m (target, anchor) {
            _internal.mount_component(workflow, target, anchor);
            current = true;
        },
        p (ctx, dirty) {
            const workflow_changes = {};
            if (dirty & /*selectedWorkflow*/ 1) workflow_changes.workflow = /*selectedWorkflow*/ ctx[0];
            workflow.$set(workflow_changes);
        },
        i (local) {
            if (current) return;
            _internal.transition_in(workflow.$$.fragment, local);
            current = true;
        },
        o (local) {
            _internal.transition_out(workflow.$$.fragment, local);
            current = false;
        },
        d (detaching) {
            _internal.destroy_component(workflow, detaching);
        }
    };
}
// (50:8) {#each workflows as workflow}
function create_each_block_3(ctx) {
    let tr;
    let td0;
    let t0_value = /*workflow*/ ctx[6].title + "";
    let t0;
    let t1;
    let td1;
    let t2_value = /*workflow*/ ctx[6].type + "";
    let t2;
    let t3;
    let td2;
    let t4_value = /*workflow*/ ctx[6].lastModifiedAt + "";
    let t4;
    let t5;
    let mounted;
    let dispose;
    function click_handler() {
        return /*click_handler*/ ctx[5](/*workflow*/ ctx[6]);
    }
    return {
        c () {
            tr = _internal.element("tr");
            ...
            t3 = _internal.space();
            td2 = _internal.element("td");
            t4 = _internal.text(t4_value);
            t5 = _internal.space();
            _internal.attr(td0, "class", "svelte-1u8kct");
            _internal.attr(td1, "class", "svelte-1u8kct");
            _internal.attr(td2, "class", "svelte-1u8kct");
        ...
        m (target, anchor) {
            ...
            _internal.append(tr, td2);
            _internal.append(td2, t4);
            _internal.append(tr, t5);
            if (!mounted) {
        ...
        p (new_ctx, dirty) {
            ctx = new_ctx;
            if (dirty & /*workflows*/ 4 && t0_value !== (t0_value = /*workflow*/ ctx[6].title + "")) _internal.set_data(t0, t0_value);
            if (dirty & /*workflows*/ 4 && t2_value !== (t2_value = /*workflow*/ ctx[6].type + "")) _internal.set_data(t2, t2_value);
            if (dirty & /*workflows*/ 4 && t4_value !== (t4_value = /*workflow*/ ctx[6].lastModifiedAt + "")) _internal.set_data(t4, t4_value);
        },
        d (detaching) {
...
// (66:8) {#each metadata?.eventDefs || [] as event}
function create_each_block_2(ctx3) {
    let div;
    let t_value = /*event*/ ctx3[12].title + "";
    let t;
    return {
        c () {
        ...
        p (ctx, dirty) {
            if (dirty & /*metadata*/ 2 && t_value !== (t_value = /*event*/ ctx[12].title + "")) _internal.set_data(t, t_value);
        },
        d (detaching) {
...
// (72:8) {#each metadata?.actionDefs || [] as action}
function create_each_block_1(ctx4) {
    let div;
    let t_value = /*action*/ ctx4[9].title + "";
    let t;
    return {
        c () {
            div = _internal.element("div");
        ...
        p (ctx, dirty) {
            if (dirty & /*metadata*/ 2 && t_value !== (t_value = /*action*/ ctx[9].title + "")) _internal.set_data(t, t_value);
        },
        d (detaching) {
            if (detaching) _internal.detach(div);
        }
...
// (78:8) {#each metadata?.workflowDefs || [] as workflow}
function create_each_block(ctx5) {
    let div;
    let t_value = /*workflow*/ ctx5[6].title + "";
    let t;
    return {
        c () {
            div = _internal.element("div");
        ...
        p (ctx, dirty) {
            if (dirty & /*metadata*/ 2 && t_value !== (t_value = /*workflow*/ ctx[6].title + "")) _internal.set_data(t, t_value);
        },
        d (detaching) {
            if (detaching) _internal.detach(div);
        }
...
function create_fragment(ctx6) {
    ...
    function select_block_type(ctx, dirty) {
        if (/*selectedWorkflow*/ ctx[0]) return 0;
        return 1;
    }
    current_block_type_index = select_block_type(ctx6, -1);
    if_block = if_blocks[current_block_type_index] = if_block_creators[current_block_type_index](ctx6);
    return {
        c () {
            if_block.c();
...
function instance($$self, $$props, $$invalidate) {
    ...
    const close_handler = ()=>$$invalidate(0, selectedWorkflow = null)
    ;
    const click_handler = (workflow)=>$$invalidate(0, selectedWorkflow = workflow)
    ;
    $$self.$$.update = ()=>{
        if ($$self.$$.dirty & /*selectedWorkflow*/ 1) {
            $: if (!selectedWorkflow) _actionsDefault.default.getAllWorkflows().then((wf)=>$$invalidate(2, workflows = wf)
            );
        }
        if ($$self.$$.dirty & /*metadata*/ 2) {
            $: if (!metadata) _actionsDefault.default.getMetadata().then((m)=>$$invalidate(1, metadata = m)
            );
        }
    };
    return [
...
},{"svelte/internal":"iVhnC","./editor/Workflow.svelte":"cAAjH","./editor/actions":"aoyHM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cAAjH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function add_css(target) {
    _internal.append_styles(target, "svelte-j0xyqw", ".workflow-editor.svelte-j0xyqw{display:flex;align-items:stretch;justify-content:center;width:100%;height:100%\r\n  }.workflow-view-panel.svelte-j0xyqw{padding-top:35px;min-width:700px;flex-grow:5}.workflow-view-container.svelte-j0xyqw{max-width:900px;margin-left:auto;margin-right:auto}.title-input.svelte-j0xyqw{border:none;outline:none;background-color:rgb(245, 245, 245);font-size:36px;width:700px;font-weight:300}.node-flow.svelte-j0xyqw{display:flex;flex-direction:column;align-items:center;padding-top:35px}.section-headers.svelte-j0xyqw{font-size:24px;font-weight:300;text-align:left;width:500px;margin:10px}.btn.svelte-j0xyqw{font-size:18px;font-weight:300;margin-left:15px;border:1px solid gainsboro;padding:5px 10px 5px 10px;border-radius:2px;vertical-align:middle;box-shadow:0px 2px 10px -8px;background-color:rgb(250, 250, 250)}.btn.svelte-j0xyqw:hover{cursor:pointer}.json-viewer.svelte-j0xyqw{white-space:pre;background-color:white;color:gray;margin-top:20px}");
}
function create_fragment(ctx1) {
    ...
    return {
        c () {
            ...
            t10 = _internal.space();
            div7 = _internal.element("div");
            code = _internal.element("code");
            div6 = _internal.element("div");
            button2 = _internal.element("button");
            button2.textContent = "Refresh";
            t12 = _internal.space();
            t13 = _internal.text(/*workflowJSON*/ ctx1[1]);
            _internal.attr(button0, "class", "close-workflow btn svelte-j0xyqw");
            _internal.attr(button0, "type", "button");
            _internal.attr(button1, "type", "button");
            _internal.attr(button1, "class", "action-editor-save-btn btn svelte-j0xyqw");
            _internal.set_style(p, "float", "right");
            _internal.attr(input, "class", "title-input svelte-j0xyqw");
            _internal.attr(input, "type", "text");
            _internal.attr(input, "placeholder", "Title");
            _internal.attr(div0, "class", "section-headers svelte-j0xyqw");
            _internal.attr(div1, "class", "section-headers svelte-j0xyqw");
            _internal.attr(div2, "class", "node-flow svelte-j0xyqw");
            _internal.attr(div3, "class", "workflow-view-container svelte-j0xyqw");
            _internal.attr(div4, "class", "workflow-view-panel svelte-j0xyqw");
            _internal.attr(div5, "class", "workflow-editor svelte-j0xyqw");
            _internal.attr(button2, "type", "button");
            _internal.attr(div7, "class", "json-viewer svelte-j0xyqw");
        },
        m (target, anchor) {
            ...
            _internal.insert(target, div7, anchor);
            _internal.append(div7, code);
            _internal.append(code, div6);
            _internal.append(div6, button2);
            _internal.append(code, t12);
            _internal.append(code, t13);
            current = true;
            if (!mounted) {
                dispose = [
                    _internal.listen(button0, "click", /*click_handler*/ ctx1[4]),
                    _internal.listen(button1, "click", /*saveWorkflow*/ ctx1[3]),
                    _internal.listen(input, "input", /*input_input_handler*/ ctx1[5]),
                    _internal.listen(button2, "click", /*click_handler_1*/ ctx1[6])
                ];
                mounted = true;
            }
        },
        p (ctx, [dirty]) {
            ...
            if (!current || dirty & /*workflowJSON*/ 2) _internal.set_data(t13, /*workflowJSON*/ ctx[1]);
        },
        i (local) {
            if (current) return;
        ...
        d (detaching) {
            ...
            if (detaching) _internal.detach(div7);
            mounted = false;
...
function instance($$self, $$props1, $$invalidate) {
    ...
    async function saveWorkflow() {
        ...
        else $$invalidate(0, workflow = await _actionsDefault.default.createWorkflow(newWorkflow));
    }
    ...
    const click_handler_1 = ()=>$$invalidate(0, workflow)
    ;
    $$self.$$set = ($$props)=>{
        if ('workflow' in $$props) $$invalidate(0, workflow = $$props.workflow);
    };
    $$self.$$.update = ()=>{
        if ($$self.$$.dirty & /*workflow*/ 1) $: $$invalidate(1, workflowJSON = JSON.stringify(workflow || null, null, 2));
    };
    return [
        workflow,
        workflowJSON,
...
},{"svelte/internal":"iVhnC","./actions":"aoyHM","./Path.svelte":"7uIm4","./Triggers.svelte":"89hkt","svelte":"4r74h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aoyHM":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7uIm4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _svelte = require("svelte");
function add_css(target) {
    _internal.append_styles(target, "svelte-yf3o6u", ".path.svelte-yf3o6u{display:flex;flex-direction:column;align-items:center;text-align:center;padding:5px;border:.5px solid black;border-radius:10px;margin:5px;position:relative}.svg-path.svelte-yf3o6u{position:absolute;left:50%;top:0;z-index:-10;width:10px;overflow:visible}");
}
function get_each_context(ctx, list, i) {
    const child_ctx = ctx.slice();
    child_ctx[5] = list[i];
...
function create_if_block_1(ctx1) {
    ...
    return {
        ...
        p (ctx, dirty) {
            const fork_changes = {};
            if (dirty & /*def*/ 1) fork_changes.def = /*step*/ ctx[5];
...
function create_if_block(ctx2) {
    ...
    return {
        ...
        p (ctx, dirty) {
            const node_changes = {};
            if (dirty & /*def*/ 1) node_changes.def = /*step*/ ctx[5];
...
// (43:2) {#each def.steps as step, stepIndex}
function create_each_block(ctx3) {
    ...
    const if_blocks = [];
    function select_block_type(ctx, dirty) {
        if (/*step*/ ctx[5].kind === "action") return 0;
        if (/*step*/ ctx[5].kind === "fork") return 1;
        return -1;
    }
    if (~(current_block_type_index = select_block_type(ctx3, -1))) if_block = if_blocks[current_block_type_index] = if_block_creators[current_block_type_index](ctx3);
    function select_handler_1(...args) {
        return /*select_handler_1*/ ctx3[3](/*stepIndex*/ ctx3[7], ...args);
    }
    ...
    return {
        ...
        m (target, anchor) {
            ...
            _internal.mount_component(addstep, target, anchor);
            current = true;
        },
        p (new_ctx, dirty) {
            ctx3 = new_ctx;
            ...
            if (current_block_type_index === previous_block_index) {
                if (~current_block_type_index) if_blocks[current_block_type_index].p(ctx3, dirty);
            } else {
                if (if_block) {
                    _internal.group_outros();
                    _internal.transition_out(if_blocks[previous_block_index], 1, 1, ()=>{
        ...
        d (detaching) {
            ...
            _internal.destroy_component(addstep, detaching);
        }
    };
}
function create_fragment(ctx4) {
    ...
    addstep.$on("select", /*select_handler*/ ctx4[2]);
    let each_value = /*def*/ ctx4[0].steps;
    let each_blocks = [];
    for(let i1 = 0; i1 < each_value.length; i1 += 1)each_blocks[i1] = create_each_block(get_each_context(ctx4, each_value, i1));
    ...
    return {
        c () {
            ...
            _internal.attr(path, "d", "M 0 2 v 6");
            _internal.attr(svg, "class", "svg-path svelte-yf3o6u");
            _internal.attr(svg, "viewBox", "0 0 10 10");
            _internal.attr(svg, "xmlns", "http://www.w3.org/2000/svg");
            _internal.attr(svg, "stroke-width", "5");
            _internal.attr(svg, "stroke-linecap", "round");
            _internal.attr(div, "class", "path svelte-yf3o6u");
        },
        m (target, anchor) {
            _internal.insert(target, div, anchor);
            ...
            _internal.append(div, svg);
            _internal.append(svg, path);
            current = true;
        },
        p (ctx, [dirty]) {
            if (dirty & /*addStep, def*/ 3) {
...
var _actionEditorSvelte = require("./ActionEditor.svelte");
var _actionEditorSvelteDefault = parcelHelpers.interopDefault(_actionEditorSvelte);
var _svelte = require("svelte");
function add_css(target) {
    _internal.append_styles(target, "svelte-1sw3dti", ".node.svelte-1sw3dti{background-color:black;padding:30px;border-radius:1000px;color:white;margin:15px;position:relative;cursor:pointer}.node-name.svelte-1sw3dti{background-color:white;padding:0 10px;border:1.75px solid black;position:absolute;color:black;font-size:10px;left:50%;top:50%;transform:translate(-50%, -50%);border-radius:10000px}.svg-path.svelte-1sw3dti{position:absolute;left:30px;top:30px;z-index:-10;width:10px;overflow:visible}");
}
function create_fragment(ctx) {
    let div1;
    let svg;
    ...
    let mounted;
    let dispose;
    function actioneditor_open_binding(value) {
        /*actioneditor_open_binding*/ ctx[4](value);
    }
    let actioneditor_props = {
        def: /*def*/ ctx[0],
        rootEl: /*self*/ ctx[1]
    };
    if (/*openEditor*/ ctx[2] !== void 0) actioneditor_props.open = /*openEditor*/ ctx[2];
    actioneditor = new _actionEditorSvelteDefault.default({
        props: actioneditor_props
    });
    _internal.binding_callbacks.push(()=>_internal.bind(actioneditor, 'open', actioneditor_open_binding)
    );
    actioneditor.$on("change-type", /*change_type_handler*/ ctx[5]);
    return {
        c () {
            div1 = _internal.element("div");
            svg = _internal.svg_element("svg");
            ...
            t0 = _internal.space();
            div0 = _internal.element("div");
            t1 = _internal.text(/*displayName*/ ctx[3]);
            t2 = _internal.space();
            _internal.create_component(actioneditor.$$.fragment);
            _internal.attr(path, "fill", "none");
            _internal.attr(path, "stroke", "black");
            _internal.attr(path, "d", "M 0 -48 v 98");
            _internal.attr(svg, "class", "svg-path svelte-1sw3dti");
            _internal.attr(svg, "viewBox", "0 0 10 10");
            _internal.attr(svg, "xmlns", "http://www.w3.org/2000/svg");
            _internal.attr(svg, "stroke-width", "5");
            _internal.attr(svg, "stroke-linecap", "round");
            _internal.attr(div0, "class", "node-name svelte-1sw3dti");
            _internal.attr(div1, "class", "node svelte-1sw3dti");
        },
        m (target, anchor) {
            _internal.insert(target, div1, anchor);
            ...
            _internal.append(div1, t2);
            _internal.mount_component(actioneditor, div1, null);
        ...
        p (new_ctx, [dirty]) {
            ctx = new_ctx;
            if (!current || dirty & /*displayName*/ 8) _internal.set_data(t1, /*displayName*/ ctx[3]);
            const actioneditor_changes = {};
            if (dirty & /*def*/ 1) actioneditor_changes.def = /*def*/ ctx[0];
            if (dirty & /*self*/ 2) actioneditor_changes.rootEl = /*self*/ ctx[1];
            if (!updating_open && dirty & /*openEditor*/ 4) {
                updating_open = true;
                actioneditor_changes.open = /*openEditor*/ ctx[2];
        ...
        i (local) {
            if (current) return;
            _internal.transition_in(actioneditor.$$.fragment, local);
            current = true;
        },
        o (local) {
            _internal.transition_out(actioneditor.$$.fragment, local);
            current = false;
        },
        d (detaching) {
            if (detaching) _internal.detach(div1);
            _internal.destroy_component(actioneditor);
...
function instance($$self, $$props1, $$invalidate) {
    ...
    const change_type_handler = (e)=>$$invalidate(3, displayName = e.detail)
    ;
    ...
    $$self.$$.update = ()=>{
        if ($$self.$$.dirty & /*def*/ 1) $: $$invalidate(3, displayName = def?.type);
    };
    return [
        def,
        self,
...
},{"svelte/internal":"iVhnC","./ActionEditor.svelte":"fVaX2","svelte":"4r74h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fVaX2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/* src/components/pages/editor/ActionEditor.svelte generated by Svelte v3.48.0 */ var _internal = require("svelte/internal");
var _svelte = require("svelte");
var _actions = require("./actions");
var _actionsDefault = parcelHelpers.interopDefault(_actions);
...
function add_css(target) {
    _internal.append_styles(target, "svelte-wcjn4e", ".action-editor.svelte-wcjn4e.svelte-wcjn4e{position:absolute;top:50%;transform:translateY(-50%);left:calc(100% + 30px);background-color:#f5f5f5;border:.5px solid black;min-width:300px;max-width:500px;width:max-content;z-index:15;border-radius:4px;cursor:default;color:black;text-align:initial;padding:15px;box-shadow:0px 3px 10px -10px}.actions.svelte-wcjn4e.svelte-wcjn4e{position:absolute;top:5px;right:5px}.section-header.svelte-wcjn4e.svelte-wcjn4e{font-size:20px;font-weight:700}.inputs-area.svelte-wcjn4e.svelte-wcjn4e{display:table}.input.svelte-wcjn4e.svelte-wcjn4e{display:table-row}.input.svelte-wcjn4e>div.svelte-wcjn4e{display:table-cell;vertical-align:top;padding-top:5px;padding-bottom:5px}.input-label.svelte-wcjn4e.svelte-wcjn4e{padding-right:10px;font-weight:700}select.svelte-wcjn4e.svelte-wcjn4e{padding:3px 7px;border-radius:2px}");
}
function get_each_context(ctx, list, i) {
    const child_ctx = ctx.slice();
    child_ctx[15] = list[i].inputName;
    child_ctx[16] = list[i].inputDef;
    return child_ctx;
}
function get_each_context_1(ctx, list, i) {
    const child_ctx = ctx.slice();
...
function create_if_block(ctx1) {
    ...
    let mounted;
    let dispose;
    let if_block0 = /*metadata*/ ctx1[1] && create_if_block_3(ctx1);
    let if_block1 = /*def*/ ctx1[0].type && create_if_block_1(ctx1);
    return {
        c () {
            div3 = _internal.element("div");
            div0 = _internal.element("div");
            ...
            _internal.attr(div0, "class", "actions svelte-wcjn4e");
            _internal.attr(div1, "class", "section-header svelte-wcjn4e");
            option.__value = undefined;
            option.value = option.__value;
            _internal.attr(select, "class", "svelte-wcjn4e");
            if (/*def*/ ctx1[0].type === void 0) _internal.add_render_callback(()=>/*select_change_handler*/ ctx1[12].call(select)
            );
            _internal.attr(div3, "class", "action-editor svelte-wcjn4e");
        },
        m (target, anchor) {
            _internal.insert(target, div3, anchor);
            _internal.append(div3, div0);
            _internal.append(div0, button);
            /*button_binding*/ ctx1[11](button);
            _internal.append(div3, t1);
            _internal.append(div3, div2);
            _internal.append(div2, label);
            _internal.append(label, div1);
            _internal.append(label, t3);
            _internal.append(label, select);
            _internal.append(select, option);
            _internal.append(option, t4);
            if (if_block0) if_block0.m(select, null);
            _internal.select_option(select, /*def*/ ctx1[0].type);
            _internal.append(div3, t5);
            if (if_block1) if_block1.m(div3, null);
            current = true;
            if (!mounted) {
                dispose = _internal.listen(select, "change", /*select_change_handler*/ ctx1[12]);
                mounted = true;
            }
        },
        p (ctx, dirty) {
            ...
            if (/*def*/ ctx[0].type) {
                if (if_block1) {
                    ...
                    if (dirty & /*def*/ 1) _internal.transition_in(if_block1, 1);
                } else {
                    if_block1 = create_if_block_1(ctx);
                    if_block1.c();
                    _internal.transition_in(if_block1, 1);
                    if_block1.m(div3, null);
                }
            } else if (if_block1) {
                _internal.group_outros();
                _internal.transition_out(if_block1, 1, 1, ()=>{
                    if_block1 = null;
                });
                _internal.check_outros();
            }
        ...
        i (local) {
            if (current) return;
            _internal.transition_in(if_block1);
            current = true;
        },
        o (local) {
            _internal.transition_out(if_block1);
            current = false;
        },
        d (detaching) {
            if (detaching) _internal.detach(div3);
            /*button_binding*/ ctx1[11](null);
...
function create_if_block_3(ctx2) {
    let each_1_anchor;
    let each_value_1 = /*metadata*/ ctx2[1].actionDefs;
    let each_blocks = [];
    for(let i1 = 0; i1 < each_value_1.length; i1 += 1)each_blocks[i1] = create_each_block_1(get_each_context_1(ctx2, each_value_1, i1));
    return {
        c () {
            for(let i = 0; i < each_blocks.length; i += 1)each_blocks[i].c();
...
// (97:12) {#each metadata.actionDefs as actionDef}
function create_each_block_1(ctx3) {
    let option;
    let t_value = /*actionDef*/ ctx3[19].title + "";
    let t;
    ...
    return {
        c () {
            option = _internal.element("option");
            t = _internal.text(t_value);
            option.__value = option_value_value = /*actionDef*/ ctx3[19].type;
            option.value = option.__value;
        },
        m (target, anchor) {
        ...
        p (ctx, dirty) {
            if (dirty & /*metadata*/ 2 && t_value !== (t_value = /*actionDef*/ ctx[19].title + "")) _internal.set_data(t, t_value);
            if (dirty & /*metadata*/ 2 && option_value_value !== (option_value_value = /*actionDef*/ ctx[19].type)) {
...
// (104:4) {#if def.type}
function create_if_block_1(ctx4) {
    let hr;
    let t0;
    let div2;
    let div0;
    ...
    let div1;
    let current;
    let if_block = /*actionType*/ ctx4[2] && create_if_block_2(ctx4);
    return {
        c () {
            ...
            div1 = _internal.element("div");
            if (if_block) if_block.c();
            _internal.attr(div0, "class", "section-header svelte-wcjn4e");
            _internal.attr(div1, "class", "inputs-area svelte-wcjn4e");
...
// (109:10) {#if actionType}
function create_if_block_2(ctx5) {
    let each_1_anchor;
    let current;
    let each_value = /*actionInputDefs*/ ctx5[5];
    let each_blocks = [];
    for(let i2 = 0; i2 < each_value.length; i2 += 1)each_blocks[i2] = create_each_block(get_each_context(ctx5, each_value, i2));
    const out = (i)=>_internal.transition_out(each_blocks[i], 1, 1, ()=>{
            each_blocks[i] = null;
        })
    ;
    return {
        ...
        p (ctx, dirty) {
            if (dirty & /*def, actionInputDefs*/ 33) {
                each_value = /*actionInputDefs*/ ctx[5];
                let i;
                for(i = 0; i < each_value.length; i += 1){
                    const child_ctx = get_each_context(ctx, each_value, i);
                    if (each_blocks[i]) {
...
// (110:12) {#each actionInputDefs as { inputName, inputDef }}
function create_each_block(ctx6) {
    let div3;
    let div0;
    let t0_value = /*inputDef*/ (ctx6[16].title || /*inputName*/ ctx6[15]) + "";
    let t0;
    let t1;
    let div2;
    let div1;
    ...
    expression = new _expressionSvelteDefault.default({
        props: {
            def: /*def*/ ctx6[0].inputs[/*inputName*/ ctx6[15]]
        }
    });
    return {
        c () {
            ...
            t2 = _internal.space();
            _internal.attr(div0, "class", "input-label svelte-wcjn4e");
            _internal.attr(div1, "class", "input-value");
            _internal.attr(div2, "class", "svelte-wcjn4e");
            _internal.attr(div3, "class", "input svelte-wcjn4e");
        },
        m (target, anchor) {
            _internal.insert(target, div3, anchor);
            _internal.append(div3, div0);
        ...
        p (ctx, dirty) {
            if ((!current || dirty & /*actionInputDefs*/ 32) && t0_value !== (t0_value = /*inputDef*/ (ctx[16].title || /*inputName*/ ctx[15]) + "")) _internal.set_data(t0, t0_value);
            const expression_changes = {};
            if (dirty & /*def, actionInputDefs*/ 33) expression_changes.def = /*def*/ ctx[0].inputs[/*inputName*/ ctx[15]];
...
function create_fragment(ctx7) {
    ...
    let mounted;
    let dispose;
    let if_block = /*showEditor*/ ctx7[3] && create_if_block(ctx7);
    return {
        c () {
            if (if_block) if_block.c();
            if_block_anchor = _internal.empty();
        ...
        m (target, anchor) {
            ...
            current = true;
            if (!mounted) {
                dispose = _internal.listen(window, "click", /*handleGlobalClick*/ ctx7[6]);
                mounted = true;
            }
        },
        p (ctx, [dirty]) {
...
function instance($$self, $$props1, $$invalidate) {
    ...
    function handleGlobalClick(e) {
        if (showEditor && e.target.isConnected && !rootEl.contains(e.target) || e.target === closeBtn) close();
    }
    function button_binding($$value) {
        _internal.binding_callbacks[$$value ? 'unshift' : 'push'](()=>{
            closeBtn = $$value;
            $$invalidate(4, closeBtn);
        });
    }
    ...
    $$self.$$set = ($$props)=>{
        if ('def' in $$props) $$invalidate(0, def = $$props.def);
        if ('rootEl' in $$props) $$invalidate(7, rootEl = $$props.rootEl);
    };
    $$self.$$.update = ()=>{
        if ($$self.$$.dirty & /*def*/ 1) {
        ...
        if ($$self.$$.dirty & /*actionType*/ 4) $: $$invalidate(10, actionInputs = Object.keys(actionType?.inputSchema.properties || {}));
        if ($$self.$$.dirty & /*actionInputs, actionType*/ 1028) $: $$invalidate(5, actionInputDefs = actionInputs.map((k)=>({
                inputName: k,
...
class ActionEditor extends _internal.SvelteComponent {
    constructor(options){
        super();
        _internal.init(this, options, instance, create_fragment, _internal.safe_not_equal, {
            def: 0,
...
exports.default = ActionEditor;

},{"svelte/internal":"iVhnC","svelte":"4r74h","./actions":"aoyHM","./expressions/Expression.svelte":"8NXYK","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4r74h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./internal/index.mjs":"iVhnC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8NXYK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function add_css(target) {
    _internal.append_styles(target, "svelte-1hy9y1r", ".empty-expression.svelte-1hy9y1r{background-color:white;display:block;min-width:70px;min-height:24px;border:1px solid black;border-radius:3px}.expression-root.svelte-1hy9y1r{position:relative}");
}
// (30:2) {:else}
function create_else_block(ctx) {
    ...
    return {
        c () {
            div = _internal.element("div");
            _internal.attr(div, "class", "empty-expression svelte-1hy9y1r");
        },
        m (target, anchor) {
            _internal.insert(target, div, anchor);
            if (!mounted) {
...
function create_fragment(ctx2) {
    ...
    function expressionselector_open_binding(value) {
        /*expressionselector_open_binding*/ ctx2[5](value);
    }
    ...
    return {
        c () {
            ...
            _internal.attr(div, "class", "expression-root svelte-1hy9y1r");
        },
        m (target, anchor) {
            _internal.insert(target, div, anchor);
...
},{"./types/ActionResultExpression.svelte":"6gYqw","./types/TextExpression.svelte":"1kd4w","./types/NumberExpression.svelte":"8UBqR","./types/DecisionExpression.svelte":"8Z8K5","./types/ConditionExpression.svelte":"eyfIN","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6gYqw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _svelte = require("svelte");
function add_css(target) {
    _internal.append_styles(target, "svelte-17ph7tr", ".logic-if-else-expression.svelte-17ph7tr{display:flex;flex-direction:row;border:1.75px solid #ff9120;border-radius:2px;flex-wrap:wrap;padding:5px;background-color:rgb(253 246 234);gap:7px 7px}.section.svelte-17ph7tr{display:flex;flex-direction:row;flex-wrap:nowrap;gap:7px 7px}");
}
function get_each_context(ctx, list, i) {
    const child_ctx = ctx.slice();
    child_ctx[7] = list[i];
...
// (26:6) {#each prevActions as prevAction}
function create_each_block(ctx) {
    let option;
    let t_value = /*prevAction*/ ctx[7].type + "";
    let t;
    let option_value_value;
    return {
        c () {
            option = _internal.element("option");
            t = _internal.text(t_value);
            option.__value = option_value_value = /*prevAction*/ ctx[7];
            option.value = option.__value;
        },
        m (target, anchor) {
            _internal.insert(target, option, anchor);
...
function create_fragment(ctx1) {
    ...
    let mounted;
    let dispose;
    let each_value = /*prevActions*/ ctx1[1];
    let each_blocks = [];
    ...
    return {
        c () {
            ...
            _internal.attr(div1, "class", "if-section section svelte-17ph7tr");
            _internal.attr(div2, "class", "logic-if-else-expression svelte-17ph7tr");
        },
        m (target, anchor) {
            _internal.insert(target, div2, anchor);
            _internal.append(div2, div1);
        ...
        p (ctx, [dirty]) {
            if (dirty & /*prevActions*/ 2) {
                each_value = /*prevActions*/ ctx[1];
                let i;
                for(i = 0; i < each_value.length; i += 1){
                    const child_ctx = get_each_context(ctx, each_value, i);
                    if (each_blocks[i]) each_blocks[i].p(child_ctx, dirty);
            ...
            if (dirty & /*def, prevActions, undefined*/ 3) _internal.select_option(select0, /*def*/ ctx[0].settings.actionId);
            if (dirty & /*def, prevActions, undefined*/ 3) _internal.select_option(select1, /*def*/ ctx[0].settings.outputName);
        },
        i: _internal.noop,
        o: _internal.noop,
        d (detaching) {
...
function create_if_block(ctx1) {
    ...
    return {
        c () {
            div = _internal.element("div");
            for(let i = 0; i < each_blocks.length; i += 1)each_blocks[i].c();
            _internal.attr(div, "class", "expression-selector svelte-1b4qgzz");
        },
        m (target, anchor) {
            _internal.insert(target, div, anchor);
            for(let i = 0; i < each_blocks.length; i += 1)each_blocks[i].m(div, null);
...
function create_each_block_1(ctx) {
    ...
    return {
        c () {
            ...
            t0 = _internal.text(t0_value);
            t1 = _internal.space();
            _internal.attr(div, "class", "svelte-1b4qgzz");
        },
        m (target, anchor) {
            _internal.insert(target, div, anchor);
            _internal.append(div, t0);
...
function create_each_block(ctx2) {
    ...
    return {
        c () {
            ...
            for(let i = 0; i < each_blocks.length; i += 1)each_blocks[i].c();
            t2 = _internal.space();
            _internal.attr(div0, "class", "category-header svelte-1b4qgzz");
            _internal.attr(div1, "class", "category-values svelte-1b4qgzz");
            _internal.attr(div2, "class", "category svelte-1b4qgzz");
        },
        m (target, anchor) {
            _internal.insert(target, div2, anchor);
            _internal.append(div2, div0);
...
},{"svelte/internal":"iVhnC","svelte":"4r74h","./expressions":"L5yrz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3eLBP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _svelte = require("svelte");
function add_css(target) {
    _internal.append_styles(target, "svelte-ss6how", ".fork.svelte-ss6how.svelte-ss6how{display:flex;flex-direction:row;padding:5px;border:.5px solid black;border-radius:10px;margin:5px;padding-top:25px;padding-bottom:25px;position:relative}.fork.svelte-ss6how svg.svelte-ss6how{position:absolute;left:0;top:0;z-index:-1;width:10px;height:10px;overflow:visible}");
}
function get_each_context(ctx, list, i) {
    const child_ctx = ctx.slice();
    child_ctx[6] = list[i];
...
// (52:2) {#each def.paths as path, pathIndex}
...
// (58:6) {#each def.paths as _, pathIndex}
function create_each_block(ctx3) {
    let path;
    let path_d_value;
    return {
...
function create_fragment(ctx4) {
    ...
    return {
        c () {
            ...
            svg = _internal.svg_element("svg");
            if (if_block) if_block.c();
            _internal.set_style(div0, "position", "absolute");
            _internal.set_style(div0, "top", "15px");
            _internal.set_style(div0, "left", "calc(50% - 5px)");
            _internal.attr(svg, "class", "svg-path svelte-ss6how");
            _internal.attr(svg, "viewBox", "0 0 10 10");
            _internal.attr(svg, "xmlns", "http://www.w3.org/2000/svg");
            _internal.attr(svg, "stroke-width", "5");
            _internal.attr(svg, "stroke-linecap", "round");
            _internal.attr(div1, "class", "fork svelte-ss6how");
        },
        m (target, anchor) {
            _internal.insert(target, div1, anchor);
            _internal.append(div1, div0);
...
var _svelte = require("svelte");
function add_css(target) {
    _internal.append_styles(target, "svelte-10pp7sk", ".add-step-container.svelte-10pp7sk.svelte-10pp7sk{position:relative;width:10px}.add-step.svelte-10pp7sk.svelte-10pp7sk{position:absolute;width:100px;height:30px;top:-15px;left:-45px;z-index:5\r\n  }.add-step.svelte-10pp7sk:hover .placeholder.svelte-10pp7sk{display:none}.add-step.svelte-10pp7sk:not(:hover) .add-step-btns.svelte-10pp7sk{display:none}.placeholder.svelte-10pp7sk.svelte-10pp7sk{font-weight:700}");
}
// (19:6) {:else}
function create_else_block(ctx) {
    let button;
...
function create_fragment(ctx1) {
    ...
    return {
        c () {
            ...
            div1 = _internal.element("div");
            if_block.c();
            _internal.attr(div0, "class", "placeholder svelte-10pp7sk");
            _internal.attr(div1, "class", "add-step-btns svelte-10pp7sk");
            _internal.attr(div2, "class", "add-step svelte-10pp7sk");
            _internal.attr(div3, "class", "add-step-container svelte-10pp7sk");
        },
        m (target, anchor) {
            _internal.insert(target, div3, anchor);
            _internal.append(div3, div2);
            _internal.append(div2, div0);
            _internal.append(div2, t);
            _internal.append(div2, div1);
            if_block.m(div1, null);
        },
        p (ctx, [dirty]) {
...
var _addStepSvelteDefault = parcelHelpers.interopDefault(_addStepSvelte);
function add_css(target) {
    _internal.append_styles(target, "svelte-1kpfr78", ".trigger-set.svelte-1kpfr78{display:flex;flex-direction:row;padding:5px;border:.5px solid black;border-radius:10px;margin:5px;position:relative}.add-trigger.svelte-1kpfr78{position:absolute;right:-45px;top:calc(50% - 5px)}");
}
function get_each_context(ctx, list, i) {
    const child_ctx = ctx.slice();
    child_ctx[2] = list[i];
...
function create_fragment(ctx2) {
    ...
    return {
        c () {
            ...
            div0 = _internal.element("div");
            _internal.create_component(addstep.$$.fragment);
            _internal.attr(div0, "class", "add-trigger svelte-1kpfr78");
            _internal.attr(div1, "class", "trigger-set svelte-1kpfr78");
        },
        m (target, anchor) {
            _internal.insert(target, div1, anchor);
            for(let i = 0; i < each_blocks.length; i += 1)each_blocks[i].m(div1, null);
