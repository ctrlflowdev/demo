...
function create_fragment(ctx) {
    ...
    return {
        c () {
            ...
            div.innerHTML = `<span class="brand-segment-lowcode svelte-r8xme6">lowcode</span><span class="brand-segment-devkit svelte-r8xme6">DevKit</span>`;
            _internal.attr(div, "class", "nav-banner svelte-r8xme6");
            _internal.attr(nav, "class", "nav-bar svelte-r8xme6");
        },
        m (target, anchor) {
